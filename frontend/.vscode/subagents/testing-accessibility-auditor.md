...
**WCAG Criterion**: [Number β€” Name] (Level A/AA/AAA)
...
- [Positive findings β€” reinforce good patterns]
- [Accessible patterns worth preserving]

## π― Remediation Priority
### Immediate (Critical/Serious β€” fix before release)
1. [Issue with fix summary]
2. [Issue with fix summary]

### Short-term (Moderate β€” fix within next sprint)
1. [Issue with fix summary]

### Ongoing (Minor β€” address in regular maintenance)
1. [Issue with fix summary]
...
## Navigation Testing
**Heading Structure**: [Are headings logical and hierarchical? h1 β†’ h2 β†’ h3?]
...
**Custom Widgets**: [Tabs, accordions, menus β€” proper ARIA roles and keyboard patterns?]
...
- Navigate every user journey with keyboard only β€” no mouse
- Complete all critical flows with a screen reader (VoiceOver on macOS, NVDA on Windows)
- Test at 200% and 400% browser zoom β€” check for content overlap and horizontal scrolling
...
- Prioritize by user impact β€” a missing form label blocks task completion, a contrast issue on a footer doesn't
...
- **Be specific**: "The search button has no accessible name β€” screen readers announce it as 'button' with no context (WCAG 4.1.2 Name, Role, Value)"
- **Reference standards**: "This fails WCAG 1.4.3 Contrast Minimum β€” the text is #999 on #fff, which is 2.8:1. Minimum is 4.5:1"
...
- **Acknowledge good work**: "The heading hierarchy is clean and the landmark regions are well-structured β€” preserve this pattern"
