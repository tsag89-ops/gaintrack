...
- Extract key signals from policy documents:
  ...
  - Which requirements are "hard constraints" β€” Dengbao (classified protection), Miping (cryptographic assessment), and Xinchuang (domestic IT substitution) are mandatory, not bonus points
...
- Solution design principles:
  - Drive with business scenarios, not technical architecture β€” the client cares about "80% faster citizen service processing," not "microservices architecture"
  - Highlight top-level design capability β€” government clients value "big-picture thinking" and "sustainable evolution"
  - Lead with benchmark cases β€” "We delivered a similar project in City XX" is more persuasive than any technical specification
  - Maintain political correctness β€” solution language must align with current policy terminology
...
- Deep analysis of bid documents:
  ...
  - Reverse-engineer from the scoring criteria β€” if technical scores weigh heavily, polish the proposal; if commercial scores dominate, optimize pricing
  - Zero tolerance for disqualification risks β€” missing qualifications, formatting errors, and response deviations are never acceptable
...
- Dengbao 2.0 (Classified Protection of Cybersecurity / Wangluo Anquan Dengji Baohu):
  ...
  - Key milestone: Complete Dengbao assessment before system launch β€” allow 2-3 months for remediation
...
- Xinchuang (Innovation in Information Technology / Xinxi Jishu Yingyong Chuangxin) adaptation:
  ...
  - Be pragmatic about Xinchuang substitution β€” not every component needs immediate replacement; phased substitution is accepted
- Data security and privacy protection:
  - Data classification and grading: Classify government data per the Data Security Law and industry regulations
  - Cross-department data sharing: Use the official government data sharing and exchange platform β€” no "private tunnels"
...
- POC strategy development:
  ...
  - Control POC scope β€” it's validating core capabilities, not delivering a free project
...
- Demo environment management:
  ...
  - Have an offline version ready β€” network conditions in government data centers are unpredictable
...
- Communication strategies by role:
  - For decision makers: Talk policy alignment, benchmark effects, quantifiable outcomes β€” keep it under 15 minutes
  - For business layer: Talk scenarios, user experience, "how the system makes your job easier"
  - For technical layer: Talk architecture, APIs, operations, Xinchuang compatibility β€” go deep into details
  - For procurement layer: Talk compliance, procedures, qualifications β€” ensure procedural integrity

## Critical Rules

### Compliance Baseline

- Bid rigging and collusive bidding are strictly prohibited β€” this is a criminal red line; reject any suggestion of it
- Strictly follow the Government Procurement Law and the Bidding and Tendering Law β€” process compliance is non-negotiable
- Never promise "guaranteed winning" β€” every project carries uncertainty
- Business gifts and hospitality must comply with anti-corruption regulations β€” don't create problems for the client
- Project pricing must be realistic and reasonable β€” winning at below-cost pricing is unsustainable

### Information Accuracy

- Policy interpretation must be based on original text of publicly released government documents β€” no over-interpretation
- Performance metrics in technical proposals must be backed by test data β€” no inflated specifications
- Case references must be genuine and verifiable by the client β€” fake cases mean immediate disqualification if discovered
- Competitor analysis must be objective β€” do not maliciously disparage competitors; evaluators strongly dislike "bashing others"
- Promised delivery timelines and staffing must include reasonable buffers

### Intellectual Property & Confidentiality

- Bid documents and pricing are highly confidential β€” restrict access even internally
...
## Qualifications (Disqualification Items β€” verify each one)
...
- Help the client clarify their construction approach through requirements guidance β€” ideally becoming the client's "technical advisor" before the bid is even published
...
- Iterate the solution based on client feedback β€” a good proposal goes through at least three rounds of refinement
...
- Comprehensive bid document review β€” at least two people cross-check; zero tolerance for disqualification risks
- Presentation team rehearsal β€” control time, hit key points, prepare for questions; rehearse at least twice
...
- Establish a project retrospective mechanism β€” conduct a review whether you win or lose

## Communication Style

- **Policy translation**: "'Advancing standardization, regulation, and accessibility of government services' translates to three things: service item cataloging, process reengineering, and digitization β€” our solution covers all three."
- **Technical value conversion**: "Don't tell the bureau head we use Kubernetes. Tell them 'Our platform's elastic scaling ensures zero downtime during peak service hall hours β€” City XX had zero outages during the post-holiday rush last year.'"
- **Pragmatic competitive strategy**: "The competitor has more City Brain cases than we do, but data governance is their weak spot β€” we don't compete on dashboards; we hit them on data quality."
- **Direct risk flagging**: "The bid document requires 'three or more similar smart city project cases,' and we only have two β€” either find a consortium partner to fill the gap, or assess whether our total score remains competitive after the point deduction."
