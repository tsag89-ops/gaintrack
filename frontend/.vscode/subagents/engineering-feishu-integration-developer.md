...
color: blue
emoji: π”—
vibe: Builds enterprise integrations on the Feishu (Lark) platform β€” bots, approvals, data sync, and SSO β€” so your team's workflows run on autopilot.
---
...
β”β”€β”€ src/
β”‚   β”β”€β”€ config/
β”‚   β”‚   β”β”€β”€ feishu.ts              # Feishu app configuration
β”‚   β”‚   β””β”€β”€ env.ts                 # Environment variable management
β”‚   β”β”€β”€ auth/
β”‚   β”‚   β”β”€β”€ token-manager.ts       # Token retrieval and caching
β”‚   β”‚   β””β”€β”€ event-verify.ts        # Event subscription verification
β”‚   β”β”€β”€ bot/
β”‚   β”‚   β”β”€β”€ command-handler.ts     # Bot command handler
β”‚   β”‚   β”β”€β”€ message-sender.ts      # Message sending wrapper
β”‚   β”‚   β””β”€β”€ card-builder.ts        # Message card builder
β”‚   β”β”€β”€ approval/
β”‚   β”‚   β”β”€β”€ approval-define.ts     # Approval definition management
β”‚   β”‚   β”β”€β”€ approval-instance.ts   # Approval instance operations
β”‚   β”‚   β””β”€β”€ approval-callback.ts   # Approval event callbacks
β”‚   β”β”€β”€ bitable/
β”‚   β”‚   β”β”€β”€ table-client.ts        # Bitable CRUD operations
β”‚   β”‚   β””β”€β”€ sync-service.ts        # Data synchronization service
β”‚   β”β”€β”€ sso/
β”‚   β”‚   β”β”€β”€ oauth-handler.ts       # OAuth authorization flow
β”‚   β”‚   β””β”€β”€ user-sync.ts           # User info synchronization
β”‚   β”β”€β”€ webhook/
β”‚   β”‚   β”β”€β”€ event-dispatcher.ts    # Event dispatcher
β”‚   β”‚   β””β”€β”€ handlers/              # Event handlers by type
β”‚   β””β”€β”€ utils/
β”‚       β”β”€β”€ http-client.ts         # HTTP request wrapper
β”‚       β”β”€β”€ logger.ts              # Logging utility
β”‚       β””β”€β”€ retry.ts               # Retry mechanism
β”β”€β”€ tests/
