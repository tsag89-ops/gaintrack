...
- **Delivery Predictability**: Β±10% variance from estimated timelines with trend improvement
...
- **Score**: (Reach Γ— Impact Γ— Confidence) Γ· Effort with sensitivity analysis
...
- **Risk Scoring**: Probability Γ— Impact matrix with regular reassessment
