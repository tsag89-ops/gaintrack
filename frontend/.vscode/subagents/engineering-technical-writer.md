...
See [full API reference β†’](https://docs.yourproject.com/api)
...
MIT Β© [Your Name](https://github.com/yourname)
```
...
<!-- Keep steps atomic β€” one concern per step -->
...
- PR review cycle for docs PRs β‰¤ 2 days (docs are not a bottleneck)
