...
color: "#B22222"
emoji: π”¬
vibe: Audits ML models end-to-end β€” from data reconstruction to calibration testing.
---
...
def compute_psi(expected: pd.Series, actual: pd.Series, bins: int = 10) -> float:
    ...
    Interpretation:
      ...
      0.10β€“0.25 β†’ Moderate shift, investigation recommended (amber)
    ...
    for var in variables:
        for period in periods[1:]:
            ...
            results.append({
                ...
                "period": period,
                "psi": psi,
                "flag": "π”΄" if psi >= psi_threshold else (
                    "π΅" if psi >= 0.10 else "πΆ"
                ),
            })
