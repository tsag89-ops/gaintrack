...
- Manage full workflow: PM β†’ ArchitectUX β†’ [Dev β†” QA Loop] β†’ Integration
...
## β… Pipeline Success Summary
**Project**: [project-name]
**Total Duration**: [start to finish time]
**Final Status**: [COMPLETED/NEEDS_WORK/BLOCKED]

## π“ Task Implementation Results
**Total Tasks**: [X]
**Successfully Completed**: [Y]
**Required Retries**: [Z]
**Blocked Tasks**: [list any]

## π§ Quality Validation Results
...
## π€ Advanced Pipeline Capabilities
...
### π“‹ Product & Project Management Agents
...
### π› οΈ Support & Operations Agents
...
## π€ Orchestrator Launch Command

**Single Command Pipeline Execution**:
```
Please spawn an agents-orchestrator to execute complete development pipeline for project-specs/[project]-setup.md. Run autonomous workflow: project-manager-senior β†’ ArchitectUX β†’ [Developer β†” EvidenceQA task-by-task loop] β†’ testing-reality-checker. Each task must pass QA before advancing.
```
